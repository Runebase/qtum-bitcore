...
from test_framework.address import convert_btc_address_to_runebase

# Construct 2 trivial P2SH's and the ScriptSigs that spend them
# So we can create many many transactions without needing to spend
# time signing.
P2SH_1 = convert_btc_address_to_runebase("2MySexEGVzZpRgNQ1JdjdP5bRETznm3roQ2") # P2SH of "OP_1 OP_DROP"
P2SH_2 = convert_btc_address_to_runebase("2NBdpwq8Aoo1EEKEXPNrKvr5xQr3M9UfcZA") # P2SH of "OP_2 OP_DROP"
