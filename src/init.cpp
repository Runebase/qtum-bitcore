...
void Shutdown()
{
    ...
    if (pwalletMain)
    {
        StakeRunebases(false, pwalletMain);
...
//////////////////////////////////////////////////////////////////////
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                if (fReindex) {
                    boost::filesystem::path stateDir = GetDataDir() / "stateRunebase";
                ...
                boost::filesystem::path runebaseStateDir = GetDataDir() / "stateRunebase";

                bool fStatus = boost::filesystem::exists(runebaseStateDir);
    ...
    if (!GetBoolArg("-staking", DEFAULT_STAKE))
        ...
        StakeRunebases(true, pwalletMain);
#endif
    // ********************************************************* Step 12: finished
