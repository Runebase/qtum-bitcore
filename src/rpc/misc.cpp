...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.push_back(Pair("maxblocksize", (uint64_t)runebaseDGP.getBlockSize(chainActive.Height())));
    obj.push_back(Pair("mingasprice", (uint64_t)runebaseDGP.getMinGasPrice(chainActive.Height())));
    obj.push_back(Pair("blockgaslimit", (uint64_t)runebaseDGP.getBlockGasLimit(chainActive.Height())));
